...
$get_Volunteer_email="select * from volunteer INNER JOIN donation_quantity ON volunteer.registered_with_ngo=donation_quantity.ngo_Id where donation_Id='$donation_id'";
