...
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/bg_2.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        ...
        <div class="form-group">	
					...
					<option selected class="bg-light p-5 contact-form"><p>Please choose your pickup location</p></option>
      ...
      <table class="table" id="dynamic_field" style="border-style:none;">  
                  ...
                  <?php 
          $query = mysqli_query($conn,"select * from ngo Inner Join item_needed on ngo.ngoId=item_needed.NgoId where item_needed.item='$item_selected'") or die(mysqli_error($conn));
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           ...
           $('#dynamic_field').append('<tr id="row'+i+'"><td><select class="form-control" id="ngo_name" name="ngo_name[]">'+
				        	    '<option selected class="bg-light p-5 contact-form"><p>Which NGO you want to donate</p></option>'+
				        	    '<option value="2">Lockdown</option>'+
